! function(t, e) {
        ...
        constructor(t = {}, e = !1) {
            this.user = function(t) {
                ...
                if (e.target = function(t) {
                    ...
                    }(t.target), e.fetchSize = Math.max(0, parseInt(t.fetchSize, 10) || 0), !e.target && !t.callback && !r.callback) throw new u("No element targeted or callback provided.");
                return {
                    ...r,
                    ...t,
                    ...e
            ...
            }(this.user, e), this.requestIndex = `${this.request.key}_${this.request.gid}_${this.user.query}`
        }
    }
    const h = {
        defaults: {
    ...
    class p {
        ...
        setAttributes() {
            ...
            this.request.state.offset || (o = s.map(((t, s) => t.label ? t.label.replace(/\s/g, "") : (r.last += 1, r.rowNumberOffset = 1, i(e[0].c[s]) || t.id))), this.request.update({
                header: r.rowNumberOffset,
                labels: o,
                offset: this.request.state.offset + r.rowNumberOffset
            })), (!t || e.length - r.rowNumberOffset < t) && (r.last += 1, this.request.update({
                loaded: !0
            }));
        ...
        setOutput() {
            this.rows = [], this.request.state.offset || this.attributes.rowNumberOffset || this.rows.push(new f(0, this.attributes.labels, this.attributes.labels)), this.raw.table.rows.forEach(((t, e) => {
        ...
        setHTML() {
            const {
                target: t
            } = this.options.user, e = this.options.user.rowTemplate || l, s = (r = t) && "TABLE" === r.tagName;
            var r;
            ...
            this.rows.forEach((t => {
                ...
                }(t, "sheetrock:loaded"), this.html = n + i
        }
        loadData(t, e) {
            this.raw = t;
            try {
    ...
    function b(t = {}, e = null) {
        ...
        return e ? n.loadData(e, i) : r && o && n && ("object" == typeof window && "document" in window ? function(t, e) {
                ...
                w += 1, window[o] = function(s) {
                    n(), t.loadData(s, e)
                }, r.addEventListener && (r.addEventListener("error", i, !1), r.addEventListener("abort", i, !1)), r.type = "text/javascript", r.src = `${t.request.url}&tqx=responseHandler:${o}`, s.appendChild(r)
            }
            /*!
             * Sheetrock
